<div class="card ">
      ...
      <div class="view overlay gradient-card-header blue-gradient">
            <h1 class="card-header-title text-center" style="color: #fff"><b>DETAILS: <?php echo $entry['folder_no']; ?></b></h1>
 <!-- </div> --></div>
 <div class="card-body card-body-cascade">

<?php echo validation_errors(); ?>
<?php echo form_open('entries/approval'); ?>
...
<div class="row">
      ...
      <div class="form-group  col-4 ">
          ...
          <div class="input-group date" id="date" data-target-input="nearest">
            <input type="text" readonly class="form-control datetimepicker-input" data-target="#date"/>
      ...
      <div class="form-group  col-4">
          ...
          <div class="input-group date" id="admission_date" data-target-input="nearest">
            <input type="text" readonly class="form-control  datetimepicker-input" data-target="#admission_date"/>
      ...
      <div class="form-group  col-4 ">
          ...
          <div class="input-group date" id="discharge_date" data-target-input="nearest">
            <input type="text" readonly class="form-control  datetimepicker-input" data-target="#discharge_date"/>
    ...
    <div class="row">
      <div class="form-group  col 6">
          ...
          <div class="input-group date" id="payment_date" data-target-input="nearest">
            <input type="text"readonly class="form-control   datetimepicker-input" data-target="#payment_date"/>
    ...
    <div class="form-group  col-4">
      ...
      <div class="form-group  col-4">
          ...
          <div class="input-group date" id="due_date"  data-target-input="nearest">
            <input type="text" readonly class="form-control datetimepicker-input" data-target="#due_date" />
      ...
      <div class="form-group  col-4">
          ...
          <div class="input-group date" id="effective_from" data-target-input="nearest">
            <input type="text" readonly class="form-control   datetimepicker-input" data-target="#effective_from" />
      ...
      <label >Date</label>
        <div class="input-group date" id="declarant_date" data-target-input="nearest">
            <input type="text" readonly="" class="form-control datetimepicker-input" data-target="#declarant_date" />
      ...
      <label >Date</label>
        <div class="input-group date" id="guarantor_date" data-target-input="nearest">
            <input type="text" readonly class="form-control datetimepicker-input" data-target="#guarantor_date" />
...
<?php if($this->session->userdata('account_type') == "Executive") : ?> 
  <div class="row">
      <div class="form-group col-8">
          ...
          <select class="select form-control" id="select" name="approval" placeholder="pending" >
       ...
       <!-- <button class="btn btn-primary btn-lg btn-block"  href="</?php echo site_url('/entries/update_approval/'.$entry['folder_no']); ?>" type="submit">Submit</button> <a class="btn btn-primary btn-lg btn-block"  href="<//?php echo site_url('entries/update_approval/'.$entry['folder_no']); ?>" type="submit">Submit</a>-->
    ...
    <?php endif; ?>
      ...
      <!-- <a type="button" class="btn btn-primary btn-lg btn-block"  href="//<//?php echo base_url(); ?>printpdf/myprint/<?//php echo $entry['folder_no']; ?>" type="submit">print</a> -->
